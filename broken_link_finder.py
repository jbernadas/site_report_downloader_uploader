...
class MySpider(CrawlSpider):
    url = "https://ncsp-prod.llnl.gov"
    name = "test-crawler"

    target_domains = [urlparse(url).netloc] # list of domains that will be allowed to be crawled
    start_urls = [url] # list of starting urls for the crawler
